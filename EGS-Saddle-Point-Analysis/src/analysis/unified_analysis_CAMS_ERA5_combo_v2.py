# -*- coding: utf-8 -*-
"""Unified Analysis V9 (Star + Grid + CAMS Filter) - Fixes Interpolation Crash
...
CASES_FILE       = "EGS_cases_2025_ready.csv"

# Output Files
OUTPUT_CORR      = "correlations_filtered_26JAN.csv"
OUTPUT_GRID      = "grid_search_filtered_26JAN.csv"
OUTPUT_STATS     = "stats_filtered_26JAN.csv"
...
def main():
    ...
    for key in sorted(data_map.keys()):
        ...
        if 'MARINE' in sources:
            ds = open_dataset(sources['MARINE'])
            df, stats = extract_events_and_stats(ds, detect_saddle_pattern(ds), 'MARINE', ds_cams)
